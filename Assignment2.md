...
* iterations - used to point to the memory where we store the number of iterations for each point, integer
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0MjgxMjEwMiw5ODUzNTQzOCwtNDk3Nz
