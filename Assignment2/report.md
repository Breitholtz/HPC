...
$$ 
We check after the square(hardcoded) norm after every iteration to see if we are sufficiently close to
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE4OTMwNzM5LC0xMjIxMDQ5MzIzLDEyNT
